...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative isolate grid aspect-[4/5] h-[400px] w-[300px] select-none place-items-center overflow-hidden rounded-[25px] border border-[#27272a] transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] ${className}`}
