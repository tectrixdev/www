...
I bought my Ideapad slim 5 14AKP10 83HX without an OS because I, of course, wanted fedora KDE on it. Since I've been using it as a daily driver for about 3 months now, I've noticed some things that are minor annoyances but have made my experience a bit worse. I have recently found a solution to both of them which I had found before but overlooked them because they seemed like they might not work. that's why I'm making this article. So you could have a guide that you know will work for your device.

<Image src={Laptop} placeholder="blur" alt="My laptop." quality={100} />
_Lenovo Ideapad slim 5 14AKP10 83HX_ - Note that this may apply to many
Ideapads.
